...
class Product(models.Model):
    ...
    product_category = models.ForeignKey('Product_category', null=True, blank=True, on_delete=models.SET_NULL)
    ...
    category = models.ForeignKey('Category', null=True, blank=True, default=1, on_delete=models.SET_NULL)
